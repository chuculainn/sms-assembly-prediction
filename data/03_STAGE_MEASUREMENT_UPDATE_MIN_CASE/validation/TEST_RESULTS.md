# 03_STAGE_MEASUREMENT_UPDATE_MIN_CASE validation

- Status: PASS
- Passed: 38/38
- Checks: 38/38 PASS
- Blocking failures: 0
- MatrixManifest rows: 167
- NPZ keys: 167
...
| MatrixManifest and NPZ key set | PASS | true | manifest=167, npz=167, unique=167 |
...
| validation attachments match current package | PASS | true | stored_status=PASS |
